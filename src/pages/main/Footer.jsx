   ...
   <footer className="position-relative footer-section z_index1">
        <div className="container">
                        ...
                        <div className="footer-contact">
                            ...
                            <div className="footer-social mb-3">
                                <ul className="m-0 p-0">
                                    <li className="d-inline-block"><a href="/" rel="noopener noreferrer" target="_blank" title="Facebook Icon"><i className="ezulix-facebook"></i></a></li>
                                    <li className="d-inline-block"><a href="/" rel="noopener noreferrer" target="_blank" title="Instagram Icon"><i className="ezulix-instagram"></i></a></li>
                                    <li className="d-inline-block"><a href="/" rel="noopener noreferrer" target="_blank" title="Linkedin Icon"><i className="fa-brands fa-linkedin-in"></i></a></li>
                                    <li className="d-inline-block twiter-icon"><a href="/" rel="noopener noreferrer" target="_blank" title="Twitter Icon"><i className="fa-brands fa-x-twitter"></i></a></li>
                                    <li className="d-inline-block"><a href="/" rel="noopener noreferrer" target="_blank" title="Pintrest Icon"><i className="fa-brands fa-pinterest-p"></i></a></li>
                                    <li className="d-inline-block"><a href="/" rel="noopener noreferrer" target="_blank" title="Youtube Icon"><i style={{fontSize: "20px"}} className="ezulix-youtube-play"></i></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
            ...
            <div className="position-relative row mt-3">
                <div className="col-sm-12 col-xl-3 col-lg-6 col-md-6 mt-3 contact-first-location ">
                    <div className="location-side position-relative">
                        ...
                        <div className="mt-2">
                            <a href="https://qmaxsoftware.in" className="visit-website-link">Visit Website <i><img src="/assets/image/icons/double-arrow.webp" width="12px" alt="arrow"/></i></a>
                        </div>
                    </div>
                </div>
            ...
            <div className="position-relative row copyright">
                ...
                <div className="col-lg-4">
                    <div className="footer-widget location_link">
                        <div className="footer-widget-block">
                            <div className="widget-inner-list">
                                <ul className="p-0">
                                    <li><a href="https://qmaxsoftware.in">Website Development Company in Delhi</a></li>
                                    <li><a href="https://qmaxsoftware.in">Website Development Company in Pune</a></li>
                                    <li><a href="https://qmaxsoftware.in">Website Development Company in Jaipur</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div className="col-lg-4">
                    <div className="footer-widget location_link">
                        <div className="footer-widget-block">
                            <div className="widget-inner-list">
                                <ul className="p-0">
                                    <li><a href="https://qmaxsoftware.in">Website Development Company in Mumbai</a></li>
                                    <li><a href="https://qmaxsoftware.in">Website Development Company in Gurugram</a></li>
                                    <li><a href="https://qmaxsoftware.in">Website Development Company in Hyderabad</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div className="col-lg-4">
                    <div className="footer-widget">
                        <div className="footer-widget-block">
                            <div className="widget-inner-list">
                                <ul className="p-0">
                                    <li><a href="https://qmaxsoftware.in">Website Development Company in Chennai</a></li>
                                    <li><a href="https://qmaxsoftware.in">Website Development Company in Bangalore</a></li>
                                    <li><a href="https://qmaxsoftware.in">Website Development Company in Chandigarh</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div className="col-sm-12 col-md-12 col-lg-5">
                    <div className="position-relative">
                        <p className="text-black m-0 text-left">2015-2026 Qmax. All Right Reserved</p>
                    </div>
                </div>
                <div className="col-sm-12 col-md-12 col-lg-7">
                    <div className="position-relative bottmlnk-list"><a href="https://qmaxsoftware.in" className="text-black">Refund and Cancellation</a>
                    <a className="text-black" href="/">Terms of Use</a
                    ><a className="text-black" href="/">Privacy Policy</a></div>
                </div>
            </div>
        </div>
    </footer>
    ...
    <div id="privacy-popup" className="privacy-popup">
        <div className="privacy-box">
            <h2>By clicking "Accept" or continuing to use Our site, you agree to our Website's <a href="https://qmaxsoftware.in" style={{color: "#fff", textDecoration: "underline"}}>Privacy Policy</a></h2>
